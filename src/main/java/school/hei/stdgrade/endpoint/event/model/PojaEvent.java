...
import static school.hei.stdgrade.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.stdgrade.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "school.hei.stdgrade.event1";
  }
}
