package school.hei.stdgrade.endpoint.event.consumer;
...
import school.hei.stdgrade.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.hei.stdgrade.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.hei.stdgrade.service.event."
